...
export class TimePickerComponent
    ...
    onTimeChange(event: NgbTimeStruct) {
        ...
        if (event == null) {
            newEvent.hour = date.hour;
            newEvent.minute = date.minute;
            newEvent.second = date.second;

            this.datetime = date;
            this.datetime.hour = newEvent.hour;
            this.datetime.minute = newEvent.minute;
            this.datetime.second = newEvent.second;
        } else {
            this.datetime = date;
