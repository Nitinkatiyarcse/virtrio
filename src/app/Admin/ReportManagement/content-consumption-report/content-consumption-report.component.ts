...
@Component({
  selector: 'app-content-consumption-report',
  templateUrl: './content-consumption-report.component.html',
  styleUrls: ['./content-consumption-report.component.css']
})
export class ContentConsumptionReportComponent implements OnInit {
  ...
  getContentConsumption() {
    ...
    this.reportService.getContentConsumption(this.getbyIdViewModel).subscribe((res) => {
      if (res.isSuccess) {
        ...
        console.log(res.contentConsumptionReport);
        this.attendeeData = res.contentConsumptionReport;
        this.primaryAttendeeData = res.contentConsumptionReport;
        this.attendeeData.forEach(element => {
          element.isChecked = false;
        });
        this.rowData = res.contentConsumptionReport;
