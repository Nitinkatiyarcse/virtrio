...
@Component({
  selector: 'app-clickactions-report',
  templateUrl: './clickactions-report.component.html',
  styleUrls: ['./clickactions-report.component.css']
})
export class ClickactionsReportComponent implements OnInit {
  ...
  getClickactions() {
    ...
    this.reportService.getClickactions(this.getbyIdViewModel).subscribe((res) => {
      if (res.isSuccess) {
        this.spinner.hide();
