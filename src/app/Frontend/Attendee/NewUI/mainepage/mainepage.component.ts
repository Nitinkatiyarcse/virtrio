...
@Component({
  selector: 'app-mainepage',
  templateUrl: './mainepage.component.html',
  styleUrls: ['./mainepage.component.css']
})
export class MainepageComponent implements OnInit {
  ...
  constructor(
    ...
    this.loginPageDetails.includeRegisterBox = true;
  ...
  ngOnInit(): void {
    ...
    this.spinner.show();
    eventDetailsForFrontendModel.eventName = 'imsec';
    eventDetailsForFrontendModel.clientName ='ims';
    eventDetailsForFrontendModel.registrationSet = 'Default' ;
    console.log(eventDetailsForFrontendModel);
  ...
  */
  initializeClock(endtime) {
    const timeinterval = setInterval(() => {
      ...
      this.timerDataH = t.hours + ' ';// + this.translate.instant('hours');// + ', ' +
      this.timerDataM = t.minutes + ' ';// + this.translate.instant('minutes');// + ', ' +
      this.timerDataS = t.seconds + ' ';// + this.translate.instant('seconds');// + ', ' +
